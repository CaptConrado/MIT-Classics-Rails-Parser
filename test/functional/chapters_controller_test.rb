...
class ChaptersControllerTest < ActionController::TestCase
  ...
  test "should create chapter" do
    assert_difference('Chapter.count') do
      post :create, chapter: { order_number: @chapter.order_number, summary: @chapter.summary, title: @chapter.title }
    end
  ...
  test "should update chapter" do
    put :update, id: @chapter, chapter: { order_number: @chapter.order_number, summary: @chapter.summary, title: @chapter.title }
    assert_redirected_to chapter_path(assigns(:chapter))
  end
